...
public abstract class Rule {
    ...
    public double getLocalF1() {
        return (2 * getQuality() * getValidPrecision()) / (getQuality() + getValidPrecision());
    }
    ...
    public static class RuleStats {
        ...
        public void setPrecision(int testSupport, int filteredPredictions) {
